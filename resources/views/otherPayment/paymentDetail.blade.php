...
@section('title', 'Other Payment Voucher Detail')
@section('content')
...
<section class="content-header">
  <h1> Other Payment Voucher Detail <small></small> </h1>
  <ol class="breadcrumb">
            ...
            <div class="box box-primary">
              <div class="box-header">
                <div class="d-flex justify-content-between">
                  <h3 class="box-title">Payment Voucher Detials</h3>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="subpage">
                      <div id="size">
                        ...
                        <p style="margin: 0px; text-align: center">পেমেন্ট ভাউচারের বিস্তারিত তথ্য</p>
                          <table width="100%">
                            <tbody>
                              <tr> 
                                <td>সিঃ নংঃ  {{$single_data->tok}}</td> 
                                <td>তারিখঃ{{dateFormateForView($single_data->payment_date)}}</td>
                              </tr>
                              <tr>
                                <td>
                                  পেমেন্ট টায়েপঃ {{$single_data->otherpayment_type_object->name}}</td>
                                <td>পেমেন্ট বিস্তারিতঃ {{$single_data->note}}</td>
                              </tr>
                            </tbody>
                          </table><br>
                          <table width="100%" border="1">
                            <thead>
                              <tr><th class="">সিঃ নংঃ</th><th class="dtl">পেমেন্ট মেথড </th><th  style="text-align:center">পরিমান </th></tr>
                            </thead>
                            <tbody>
                              <tr>
                                <td class="">1</td>
                                <td class="dtl1">{{$single_data->otherpayment_bank_object->bank_name}}</td>
