...
@section('title', 'Other Payment Type')
@section('content')
...
<section class="content-header">
  <h1> {{ __('messages.other_payment_type') }} <small></small> </h1>
  <ol class="breadcrumb">
...
<section class="content">
  ...
  <div class="row">
    ...
    <div class="col-md-8">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-list-alt"></i> {{ __('messages.payment_type_list') }}</h3>
          <div class="form-inline pull-right">
            <div class="input-group">
              <a href="{{$baseUrl.'/'.config('app.op').'/payment-sub-type'}}" class="btn btn-success btn-xs"><i class="fa fa-plus-circle"></i> {{ __('messages.sub_type') }} {{ __('messages.add') }}</a>
            </div>
          </div>
        </div>
        <!-- /.box-header -->
                            ...
                            <div class="modal-dialog modal-md">
                              ...
                              <div class="modal-content">
                                <div class="modal-header">
                                  ...
                                  <h4 class="modal-title">{{ __('messages.edit') }} {{ __('messages.other_payment_type') }}</h4>
                                </div>
