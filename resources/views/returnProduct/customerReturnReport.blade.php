    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-list-alt"></i> {{ __('messages.sell_return_from_customer') }}</h3>
        ...
        <div class="box-body">
          <div class="row">
                  ...
                  <tbody>
                    <tr>
                      <td style="text-align: center;">
                        <form method="post" action="{{ route('return-list-from-customer.filter') }}">
            ...
            <div class="col-md-12" id="printTable">
              <center><h4 style="margin: 0px">Product Return From Customer</h4></center>
                ...
                <table style="width: 100%; font-size: 12px;" cellspacing="0" cellpadding="0"> 
                  ...
                  <tbody> 
                    ...
                    <tr> 
                      ...
                      <td style="border: 1px solid #ddd; padding: 3px 3px"><a href="{{$baseUrl.'/'.config('app.return').'/cus-return-details/'.$data->tok}}">{{$data->invoice_no}}</a></td>
                      <td style="border: 1px solid #ddd; padding: 3px 3px">{{$data->productreturn_customer_object->name}}</td>
                    ...
                    @endif
                    <tr>
                        <td style="font-weight: bold; border: 1px solid #ddd; padding: 3px 3px; text-align: right" colspan="4">Total</td>
                        <td style="font-weight: bold; border: 1px solid #ddd; padding: 3px 3px;">{{Session::get('currency')}} {{number_format($ttl, 2)}}</td>
                    </tr>
                  </tbody>
                </table>
