                ...
                <table class="table table-bordered table-striped table-responsive table-hover">
                  <thead> 
                    <tr> 
                      ...
                      <th width="20%">{{ __('messages.sold_qnty') }}</th>
                  ...
                  <tbody class="row_container"> 
                    ...
                    <tr id="div_{{$rowCount}}">
                      ...
                      <td>{{$data->quantity}}</td>
                      <td> 
                        <input type="number" name="multidata[<?php echo $rowCount?>][return_qnty]" class="form-control" id="RQnty_{{$rowCount}}" value="" onkeyup="multiply(<?php echo $rowCount?>);" autocomplete="off" min="0" required="">
                      </td>
                      <td> 
                        <input type="text" name="multidata[<?php echo $rowCount?>][rate]" class="form-control" id="Rate_{{$rowCount}}" value="{{$data->unit_price}}" onkeyup="multiply(<?php echo $rowCount?>);">
                      </td>
                      <td> 
