...
<section class="content-header">
  <h1> {{ __('messages.branch_mm') }}  <small></small> </h1>
  <ol class="breadcrumb">
    <li><a href="{{URL::To('dashboard')}}"><i class="fa fa-dashboard"></i> {{ __('messages.home') }}</a></li>
    <li class="active">{{ __('messages.branch') }}</li>
  </ol>
</section>
<!-- Main content -->
<section class="content">
  ...
  <div class="row">
    <div class="col-md-4">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-plus-circle"></i> {{ __('messages.branch_mm') }}</h3>
        </div>
        <!-- /.box-header -->
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="form-group"> 
                ...
                <input type="text" name="phone" class="form-control" value="" autocomplete="off" required>
              </div>
              <div class="form-group"> 
    ...
    <div class="col-md-8">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-list-alt"></i> {{ __('messages.branch') }} {{ __('messages.list') }}</h3>
                ...
                <table class="table table-bordered table-striped table-responsive table-hover myTable"> 
                  ...
                  <tbody> 
                    ...
                    <tr> 
                      ...
                      <td>
                          <?php
                            echo $stockQnty = DB::table('stock_product')->where('branch_id', $data->id)->sum('quantity');
                          ?>
                      </td>
                      <td> 
                        <?php
                            ...
                            <div class="modal-dialog modal-sm">
                              ...
                              <div class="modal-content">
                                <div class="modal-header">
                                  ...
                                  <h4 class="modal-title"><i class="fa fa-edit"></i> {{ __('messages.branch') }} {{ __('messages.edit') }}</h4>
                                </div>
                                ...
                                <div class="modal-body">
                                  <div class="row">
                                    <div class="col-md-12">
                                      <div class="form-group">
                                        <label for="Group Name">{{ __('messages.branch') }} <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" value="{{$data->name}}" name="name" required>
                                      </div>
                                      <div class="form-group">
                                        <label for="Group Name">{{ __('messages.phone') }} <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" value="{{$data->phone}}" name="phone" required>
                                      </div>
                                      <div class="form-group">
                                        <label for="Group Name">{{ __('messages.address') }} <span class="text-danger">*</span></label>
