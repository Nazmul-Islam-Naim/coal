...
<section class="content-header">
  <h1>Distribution Report By Mother Vasel<small></small> </h1>
  <ol class="breadcrumb">
    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-list-alt"></i>Distribution Report By Mother Vasel</h3>
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-12" id="printTable">
              <center><h4 style="margin: 0px">Distribution Report By Mother Vasel</h4></center>
                ...
                <table style="width: 100%; font-size: 12px;" cellspacing="0" cellpadding="0"> 
                  <thead> 
                    <tr style="background: #ccc;"> 
                      ...
                      <th style="font-weight: bold; border: 1px solid #ddd; padding: 3px 3px">Mother Vasle</th>
                      <th style="font-weight: bold; border: 1px solid #ddd; padding: 3px 3px">Quantity</th>
                      <th style="font-weight: bold; border: 1px solid #ddd; padding: 3px 3px; width: 10%">Action</th>
                    </tr>
                  </thead>
                  <tbody> 
                    <?php                           
                    ...
                    <tr> 
                      ...
                      <td style="border: 1px solid #ddd; padding: 3px 3px"></td>
                      <td style="border: 1px solid #ddd; padding: 3px 3px">
                        <a href="#" class="btn btn-sm btn-primary"><i class="fa fa-book" style="margin-right: 5px"></i>Report</a>
                      </td>
                    </tr>
                    @endforeach
                    @if($rowCount==0)
