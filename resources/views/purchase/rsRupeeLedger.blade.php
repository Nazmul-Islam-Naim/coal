...
@section('title', 'RS Rupee Ledger')
@section('content')
<!-- Content Header (Page header) -->
<section class="content-header">
  <h1> RS Rupee Ledger <small></small> </h1>
  <ol class="breadcrumb">
    <li><a href="{{URL::To('dashboard')}}"><i class="fa fa-dashboard"></i> {{ __('messages.home') }}</a></li>
    <li class="active">RS Rupee Ledger</li>
  </ol>
</section>
<!-- Main content -->
    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-list-alt"></i> RS Rupee Ledger</h3>
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-12" id="printTable">
              ...
              <center><h4 style="margin:0">RS Rupee Ledger</h4></center>
