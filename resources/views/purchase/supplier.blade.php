...
<section class="content-header">
  <h1> {{ __('messages.exporter_mm') }} <small></small> </h1>
  <ol class="breadcrumb">
    <li><a href="{{URL::To('dashboard')}}"><i class="fa fa-dashboard"></i> {{ __('messages.home') }}</a></li>
    <li class="active">{{ __('messages.exporter_info') }}</li>
  </ol>
</section>
<!-- Main content -->
<section class="content">
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-plus-circle"></i> {{ __('messages.exporter_info') }} {{ __('messages.add') }}</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <div class="row">
    ...
    <div class="col-md-8">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-list-alt"></i> EXPORTER {{ __('messages.list') }}</h3>
                ...
                <table class="table table-bordered table-striped table-responsive table-hover myTable"> 
                  ...
                  <tbody> 
                    ...
                    <tr> 
                      ...
                      <td><a href="{{$baseUrl.'/'.config('app.supplier').'/exporter-ledger/'.$data->id}}" target="_blank">{{$data->name}}</a></td>
                      <!--<td>{{$data->company}}</td>-->
                      <td>{{$data->phone}}</td>
                      <td>{{$data->address}}</td>
                      ...
                      <td>
                        <div class="dropdown">
                          ...
                          <ul class="dropdown-menu" style="border: 2px solid #00a65a;"> 
                            <li><a href="{{ route('product-supplier.edit', $data->id) }}">Edit</a></li>
