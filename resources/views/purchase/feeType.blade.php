...
<section class="content-header">
  <h1> {{ __('messages.fee_type') }} <small></small> </h1>
  <ol class="breadcrumb">
    <li><a href="{{URL::To('dashboard')}}"><i class="fa fa-dashboard"></i> {{ __('messages.home') }}</a></li>
    <li class="active">{{ __('messages.fee_type') }}</li>
  </ol>
</section>
<!-- Main content -->
<section class="content">
  ...
  <div class="row">
    <div class="col-md-4">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-plus-circle"></i> {{ __('messages.fee_type') }} {{ __('messages.add') }}</h3>
        </div>
        <!-- /.box-header -->
        {!! Form::open(array('route' =>['fee-type.store'],'method'=>'POST')) !!}
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
    ...
    <div class="col-md-8">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-list-alt"></i> {{ __('messages.fee_type') }} {{ __('messages.list') }}</h3>
          <a href="{{$baseUrl.'/'.config('app.purchase').'/lc-fees'}}" class="btn btn-success btn-xs pull-right"><i class="fa fa-list-alt"></i> Add Fees</a>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <div class="row">
                    ...
                    <tr> 
                      ...
                      <td> 
                        <div class="form-inline">
                          ...
                          <!--<div class = "input-group"> 
                            {{Form::open(array('route'=>['fee-type.destroy',$data->id],'method'=>'DELETE'))}}
                            ...
                            <div class="modal-dialog modal-md">
                              ...
                              <div class="modal-content">
                                <div class="modal-header">
                                  ...
                                  <h4 class="modal-title"> {{ __('messages.fee_type') }} {{ __('messages.edit') }}</h4>
                                </div>

                                {!! Form::open(array('route' =>['fee-type.update', $data->id],'method'=>'PUT')) !!}
