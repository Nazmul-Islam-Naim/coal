                  ...
                  <table class="table"> 
                    ...
                    <tbody class="row_container"> 
                      <tr id="div_{{$row_num}}"> 
                        ...
                        <td> 
                          <input type="number" name="purchase_details[{{$row_num}}][quantity]" class="form-control" id="quantity_{{$row_num}}" onkeyup="multiply(<?php echo $row_num?>);" required="" autocomplete="off">
                        </td>
                        <td> 
                        ...
                        <td> 
                          <input type="text" name="total[]" class="form-control" id="Total_{{$row_num}}">
                        </td>
                        <td></td> 
                      </tr> 
                    </tbody> 
                    <tfoot>
                      ...
                      <tr> 
                        <td colspan="5" style="text-align: right">
                          <input type="submit" name="purchase" class="btn btn-sm btn-success" value="Purchase">
                        </td>
                        <td></td>
                      </tr>
                    </tfoot>
...
<script type="text/javascript">
  ...
  function addrow(){ 
    ...
    html +='</td>'; 
    html +='<td>';
    html +='<input type="number" name="purchase_details['+RowNum+'][quantity]" class="form-control" id="quantity_'+RowNum+'" onkeyup="multiply('+RowNum+');" autocomplete="off">'; 
    html +='</td>'; 
    html +='<td>';
    ...
    html +='</td>';
    html +='<td>';
    html +='<input type="text" name="total[]" class="form-control" id="Total_'+RowNum+'">'; 
    html +='</td>';
    html +='<td>'; 
