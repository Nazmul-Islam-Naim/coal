    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-list-alt"></i>LC Expire</h3>
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-12" id="printTable">
              <center><h4 style="margin: 0px">LC Expire</h4></center>
                ...
                <table style="width: 100%; font-size: 12px;" cellspacing="0" cellpadding="0"> 
                  <thead> 
                    <tr style="background: #ccc;"> 
                      ...
                      <th style="font-weight: bold; border: 1px solid #ddd; padding: 3px 3px">LC Opening Date</th>
                      <th style="font-weight: bold; border: 1px solid #ddd; padding: 3px 3px">LC Expire Date</th>
                  ...
                  <tbody> 
                    ...
                    <tr> 
                      ...
                      <td style="border: 1px solid #ddd; padding: 3px 3px"></td>
                      <td style="border: 1px solid #ddd; padding: 3px 3px"></td>
                      <td style="border: 1px solid #ddd; padding: 3px 3px; width:15%">
                        <a href="{{URL::to('purchase/lc-amendment')}}" class="btn btn-primary btn-sm" title="Payment">Amendment</a>
                        <!-- Start Modal for Add fee -->
                        <div id="payment{{$data->id}}" class="modal fade" role="dialog">
                          <div class="modal-dialog modal-md">
                            <!-- Modal content-->
                            <div class="modal-content">
                              <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                <h4 class="modal-title">LC Payment</h4>
                              </div>
                              ...
                              <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-6 form-group">
                                      ...
                                      <input type="text" class="form-control" value="{{$data->name}}" name="lc_no" required readonly>
                                    </div>
                                    <div class="col-md-6 form-group">
                                      <label for="Group Name">Due ($) <span class="text-danger">*</span></label>
                                      <input type="number" class="form-control" value="{{$data->name}}" name="due" required >
                                    </div>
                                    <div class="col-md-6 form-group">
                                      <label for="Group Name">Dollar Rate (BDT) <span class="text-danger">*</span></label>
                                      <input type="number" class="form-control" value="{{$data->name}}" name="due" required >
                                    </div>
                                    <div class="col-md-6 form-group">
                                      <label for="Group Name">Due (BDT) <span class="text-danger">*</span></label>
                                      <input type="number" class="form-control" value="{{$data->name}}" name="due" required >
                                    </div>
                                    <div class="col-md-6 form-group">
                                      <label for="Group Name">Payment/Receive<span class="text-danger">*</span></label>
                                      <select name="pay_rece" class="form-control" required>
                                        <option value="">Choose an account</option>
                                      </select>
                                    </div>
                                    <div class="col-md-6 form-group">
                                      <label for="Group Name">Note <span class="text-danger">*</span></label>
                                      <input type="text" class="form-control" value="{{$data->phone}}" name="note" required>
                                    </div>
                                </div>
                              </div>
