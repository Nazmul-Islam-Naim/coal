...
@section('title', 'LC Product Status')
@section('content')
    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-list-alt"></i> LC Product Status</h3>
          <div class="form-inline pull-right">
            ...
            <div class="input-group">
              <div style="right:0;margin-right:20px;" id="print_icon"><a onclick="printReport();" href="javascript:0;">
                <img class="img-thumbnail" style="width:30px;" src='{{asset("custom/img/print.png")}}'></a></div>
            </div>
          </div>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <div class="row">
                  ...
                  <tbody>
                    <tr>
                      <td style="text-align: center;">
                        <form method="get" action="{{ route('lc-product-status') }}">
            ...
            <div class="col-md-12" id="printTable">
              <center><h4 style="margin: 0px">LC Product Status</h4></center>
              <div class="table-responsive">
                <table style="width: 100%; font-size: 12px;" cellspacing="0" cellpadding="0"> 
                  <thead> 
                    <tr style="background: #ccc;"> 
                      ...
                      <th style="font-weight: bold; border: 1px solid #ddd; padding: 3px 3px">Total Quantity</th>
                      <th style="font-weight: bold; border: 1px solid #ddd; padding: 3px 3px">Receive Quantity</th>
                      <th style="font-weight: bold; border: 1px solid #ddd; padding: 3px 3px">Due Quantity</th>
                    </tr>
                  </thead>
                  <tbody> 
                    <?php                           
                    ...
                    <tr> 
                      ...
                      <td style="border: 1px solid #ddd; padding: 3px 3px">{{$data->product->product_type_object->name ?? ''}}</td>
                      <td style="border: 1px solid #ddd; padding: 3px 3px">{{$data->total_quantity}}</td>
                      <td style="border: 1px solid #ddd; padding: 3px 3px">{{$data->receive_quantity}}</td>
                      <td style="border: 1px solid #ddd; padding: 3px 3px">{{$data->due_quantity}}</td>
                    </tr>
                    @endforeach
                    @if($rowCount==0)
                      <tr>
