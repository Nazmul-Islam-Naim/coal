...
@section('title', 'LC Payment Report')
@section('content')
    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-list-alt"></i>LC Payment Report</h3>
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-12" id="printTable">
              <center><h4 style="margin: 0px">LC Payment Report</h4></center>
                ...
                <table style="width: 100%; font-size: 12px;" cellspacing="0" cellpadding="0"> 
                  <thead> 
                    <tr style="background: #ccc;"> 
                      ...
                      <th style="font-weight: bold; border: 1px solid #ddd; padding: 3px 3px">Country Of Origin</th>
                      ...
                      <th style="font-weight: bold; border: 1px solid #ddd; padding: 3px 3px">Amount (BDT)</th>
                      <th style="font-weight: bold; border: 1px solid #ddd; padding: 3px 3px">Margin</th>
                      <th style="font-weight: bold; border: 1px solid #ddd; padding: 3px 3px">Rest Amount</th>
