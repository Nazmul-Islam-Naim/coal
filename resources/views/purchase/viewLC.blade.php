...
<section class="content-header">
  <h1>{{ __('messages.LC_list') }}<small></small> </h1>
  <ol class="breadcrumb">
    <li><a href="{{URL::To('dashboard')}}"><i class="fa fa-dashboard"></i> {{ __('messages.home') }}</a></li>
    <li class="active">{{ __('messages.LC_list') }}</li>
  </ol>
</section>
<style type="text/css">
    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-list-alt"></i> {{ __('messages.LC_list') }}</h3>
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-12" id="printTable">
              <center><h4 style="margin: 0px">{{ __('messages.LC_list') }}</h4></center>
                ...
                <table style="width: 100%; font-size: 12px;" cellspacing="0" cellpadding="0"> 
                  ...
                  <tbody> 
                    ...
                    <tr> 
                      ...
                      <td style="border: 1px solid #ddd; padding: 3px 3px"><a href="{{url::to('/purchase/lc-detail',$data->id)}}"><b>{{$data->lc_no}}</b></a></td>
                      ...
                      <td style="border: 1px solid #ddd; padding: 3px 3px; Width:5%">
                        <a href="{{ route('lc.edit', $data->id) }}" class="btn btn-sm btn-primary" title="Edit"><i class="fa fa-pencil"></i> Edit LC</a>
                        
                        <a href="{{ route('lc-complete', $data->id) }}" class="btn btn-sm btn-success" title="Complete" onclick="return confirm('Are yu sure?')"><i class="fa fa-check"></i> Complete LC</a>  
                      </td>
                    </tr>
                    @endforeach
                    @if($rowCount==0)
