        ...
        <div class="box-body">
          <div class="row">
                      ...
                      <td style="text-align: center;">
                        <form method="post" action="{{ route('bill-collection.filter') }}">
                          ...
                          <div class="form-inline">
                            ...
                            <div class="form-group">
                              <label>Search : </label>
                              <input type="text" name="input" class="form-control" placeholder="Customer/Job Card No">
                            </div>
                            <div class="form-group">
            ...
            <div class="col-md-12" id="printTable">
              <center><h4 style="margin: 0px">{{ __('messages.bill_collection_report') }}</h4></center>
              <div class="table-responsive">
                ...
                <table style="width: 100%; font-size: 14px;" cellspacing="0" cellpadding="0"> 
                  ...
                  <tbody> 
                    ...
                    <tr> 
                      ...
                      <td style="border: 1px solid #ddd; padding: 3px 3px"><a href="{{$baseUrl.'/'.config('app.customer').'/customer-ledger/'.$data->customer_id}}">{{$data->ledger_customer_object->name}}</a></td>
                      <td style="border: 1px solid #ddd; padding: 3px 3px">{{$data->ledger_customer_object->phone}}</td>
                      <td style="border: 1px solid #ddd; padding: 3px 3px">{{$data->ledger_customer_object->address}}</td>
                      <td style="border: 1px solid #ddd; padding: 3px 3px">{{$data->ledger_bank_object->bank_name}}</td>
