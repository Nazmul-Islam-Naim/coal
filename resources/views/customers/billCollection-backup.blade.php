                ...
                <table class="table table-bordered table-striped table-responsive table-hover myTable"> 
                  ...
                  <tbody> 
                    ...
                    <tr> 
                      ...
                      <td>
                        <a data-toggle="modal" data-target="#myModal_{{$data->id}}" class="btn btn-warning btn-xs">Collect Bill</a>
                      </td>
                      <!-- Modal -->
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              ...
                              <div class="form-group">
                                ...
                                <input type="date" name="collect_date" class="form-control" value="<?php echo date('Y-m-d');?>">
                              </div>
                              <div class="form-group">
