    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-list-alt"></i> Payable Suppliers</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <div class="row">
                ...
                <table class="table table-bordered table-striped table-responsive table-hover myTable"> 
                  ...
                  <tbody> 
                    <?php                           
                      ...
                      $rowCount = 0;
                    ?>
                    @foreach($payableSuppliers as $data)
                      <?php $rowCount++; ?>
                    <tr> 
                      <td>
                      ...
                      <td> 
                        <div class="form-inline">
                          <div class = "input-group">
                            <a href="{{route('payment-form',$data->id)}}" class="btn btn-primary btn-xs" style="padding: 1px 15px">Payment</a>     
                          </div>
                        </div>
                      </td>
                    </tr>
