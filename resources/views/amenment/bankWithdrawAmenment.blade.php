...
<section class="content-header">
  <h1> {{ __('messages.bank_withdraw_amendment') }}<small></small> </h1>
  <ol class="breadcrumb">
    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h4 class="box-title"><i class="fa fa-pencil"></i> {{ __('messages.bank_withdraw_amendment') }}</h4>
        </div>
        <!-- /.box-header -->
                  ...
                  <tbody>
                    <tr>
                      <td style="text-align: center;">
                        <form method="post" action="{{ route('bank-withdraw.filter') }}">
                    ...
                    <tr> 
                      ...
                      <td>
                        ...
                        <div class="form-inline">
                          ...
                          <div class="input-group"> 
                            {{Form::open(array('route'=>['bank-withdraw-amendment.destroy',$data->tok],'method'=>'DELETE'))}}
                              ...
                              <div class="modal-dialog modal-sm">
                                ...
                                <div class="modal-content">
                                  <div class="modal-header">
                                    ...
                                    <h4 class="modal-title">Edit Bank Withdraw</h4>
                                  </div>
                                  {!! Form::open(array('route' =>['edit-bank-withdraw', $data->tok],'method'=>'PUT')) !!}
