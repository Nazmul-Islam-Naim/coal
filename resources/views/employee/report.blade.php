...
<section class="content-header">
  <h1> {{ __('messages.salary_report') }} <small></small> </h1>
  <ol class="breadcrumb">
    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-list-alt"></i> {{ __('messages.salary_report') }}</h3>
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-12" id="printTable">
              <center><h4 style="margin: 0px">{{ __('messages.salary_report') }}</h4></center>
              <div class="table-responsive">
                ...
                <table style="width: 100%; font-size: 12px;" cellspacing="0" cellpadding="0"> 
                  ...
                  <tbody> 
                    ...
                    <tr>
                      ...
                      <td style="border: 1px solid #ddd; padding: 3px 3px">{{ucfirst($data->month)}}</td>
                      <td style="border: 1px solid #ddd; padding: 3px 3px">{{$data->ledger_employee_object->employee_id}}</td>
                      <td style="border: 1px solid #ddd; padding: 3px 3px"><a href="{{$baseUrl.'/'.config('app.employee').'/employee-ledger/'.$data->employee_id}}">{{$data->ledger_employee_object->name}}</a></td>
