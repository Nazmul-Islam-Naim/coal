...
<section class="content-header">
  <h1> Product Unit <small></small> </h1>
  <ol class="breadcrumb">
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-4">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-plus-circle"></i> {{ __('messages.add') }} Product Unit</h3>
        </div>
        <!-- /.box-header -->
        {!! Form::open(array('route' =>['product-brand.store'],'method'=>'POST')) !!}
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
    ...
    <div class="col-md-8">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-list-alt"></i> Product Unit List</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <div class="row">
                    ...
                    <tr> 
                      ...
                      <td> 
                        <div class="form-inline">
                          ...
                          <div class = "input-group"> 
                            {{Form::open(array('route'=>['product-brand.destroy',$data->id],'method'=>'DELETE'))}}
                            ...
                            <div class="modal-dialog modal-md">
                              ...
                              <div class="modal-content">
                                <div class="modal-header">
                                  ...
                                  <h4 class="modal-title">{{ __('messages.edit') }} {{ __('messages.product_unit') }}</h4>
                                </div>

                                {!! Form::open(array('route' =>['product-brand.update', $data->id],'method'=>'PUT')) !!}
