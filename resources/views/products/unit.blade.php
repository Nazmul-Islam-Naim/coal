...
<section class="content-header">
  <h1> {{ __('messages.product_unit') }} <small></small> </h1>
  <ol class="breadcrumb">
    <li><a href="{{URL::To('dashboard')}}"><i class="fa fa-dashboard"></i> {{ __('messages.home') }}</a></li>
    <li class="active">{{ __('messages.product_unit') }}</li>
  </ol>
</section>
<!-- Main content -->
<section class="content">
  ...
  <div class="row">
    <div class="col-md-4">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-plus-circle"></i> {{ __('messages.product_unit') }} {{ __('messages.add') }}</h3>
        </div>
        <!-- /.box-header -->
        {!! Form::open(array('route' =>['product-unit.store'],'method'=>'POST')) !!}
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
    ...
    <div class="col-md-8">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-list-alt"></i> {{ __('messages.list') }} {{ __('messages.product_unit') }}</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <div class="row">
                    ...
                    <tr> 
                      ...
                      <td> 
                        <div class="form-inline">
                          ...
                          <div class = "input-group"> 
                            {{Form::open(array('route'=>['product-unit.destroy',$data->id],'method'=>'DELETE'))}}
                            ...
                            <div class="modal-dialog modal-sm">
                              ...
                              <div class="modal-content">
                                <div class="modal-header">
                                  ...
                                  <h4 class="modal-title"><i class="fa fa-edit"></i> {{ __('messages.edit') }} {{ __('messages.product_unit') }}</h4>
                                </div>

                                {!! Form::open(array('route' =>['product-unit.update', $data->id],'method'=>'PUT')) !!}
