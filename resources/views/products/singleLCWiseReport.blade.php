...
@section('title', 'Single LC Wise Report')
@section('content')
...
<section class="content-header">
  <h1>Single LC Wise Report<small></small> </h1>
  <ol class="breadcrumb">
    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-list-alt"></i>Single LC Wise Report</h3>
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-12" id="printTable">
              <center><h4 style="margin: 0px">Single LC Wise Report</h4></center>
                  ...
                  <tbody> 
                    ...
                    <tr> 
                      ...
                      <td style="border: 1px solid #ddd; padding: 3px 3px; Width:15%">
                        <a href="#" class="btn btn-sm btn-primary"></i>Distribute</a>
                      </td>
                    </tr>
                    @endforeach
                    @if($rowCount==0)
