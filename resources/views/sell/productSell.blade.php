...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">{{ __('messages.sell_product') }}</li>
  </ol>
</section>
<!-- Main content -->
    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-plus-circle"></i> {{ __('messages.sell_product') }}</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <div class="row">
            <div class="col-md-3">
              <div class="form-group"> 
                <label>{{ __('messages.customer') }} <span style="color: red">*</span></label>
            ...
            <div class="col-md-3">
              <div class="form-group"> 
                <label>{{ __('messages.branch') }} <span style="color: red">*</span></label>
                  ...
                  <table class="table"> 
                    <thead> 
                      <tr>
                        ...
                        <th style="text-align: center">{{ __('messages.truck_ship_no') }} <span style="color: red">*</span></th>
                    ...
                    <tfoot>
                      ...
                      <tr> 
                        <td colspan="4" style="text-align: right"><b>{{ __('messages.paid_amount') }}</b></td>
                        <td>
                      ...
                      <tr> 
                        <td colspan="4" style="text-align: right"><b>{{ __('messages.bank') }}</b></td>
                        <td>
...
<script type="text/javascript">
  ...
  function addrow(){  
    ...
    html +='<td>'; 
    html +='<select class="form-control allProductList select2" name="sell_details['+RowNum+'][product_id]" onchange="getProductDetails(this.value, '+RowNum+')" required=""></select>'; 
    html +='</td>'; 
    /* html +='<td>'; 
    ...
    html +='</td>';*/
    html +='<td>';
    html +='<input type="text" name="sell_details['+RowNum+'][truck_no]" class="form-control" autocomplete="off">'; 
    html +='</td>';
    html +='<td>';
    html +='<input type="text" name="sell_details['+RowNum+'][quantity]" class="form-control individualBookQnty" id="quantity_'+RowNum+'" onkeyup="multiply('+RowNum+');" required="" autocomplete="off">'; 
    html +='</td>'; 
    html +='<td>';
    html +='<input type="text" name="sell_details['+RowNum+'][unit_price]" class="form-control individualBookPrice" id="rate_'+RowNum+'" onkeyup="multiply('+RowNum+');" required="" autocomplete="off">'; 
    html +='</td>';
    html +='<td>';
