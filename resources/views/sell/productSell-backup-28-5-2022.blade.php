          ...
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="form-group"> 
                ...
                <input type="text" name="purchase_date" class="form-control datepicker" value="<?php echo date('Y-m-d');?>" required="">
              </div>
            </div>
            <div class="col-md-3">
              <div class="form-group"> 
                    ...
                    <tfoot>
                      ...
                      <tr> 
                        <td colspan="5" style="text-align: right">
                          <button type="submit" name="purchase" class="btn btn-md btn-success"><i class="fa fa-shopping-cart"></i> Purchase</button>
                        </td>
                        <td></td>
                      </tr>
                    </tfoot>
...
<script type="text/javascript">
  ...
  function addrow(){  
    ...
    html +='<td>'; 
    html +='<select class="form-control allProductList" name="purchase_details['+RowNum+'][product_id]" onchange="getProductDetails(this.value, '+RowNum+')"></select>'; 
    html +='</td>'; 
    html +='<td>';
    html +='<input type="text" class="form-control individualBookStockQnty" id="stockqnty_'+RowNum+'" readonly>'; 
    html +='</td>'; 
    html +='<td>';
    html +='<input type="number" name="purchase_details['+RowNum+'][quantity]" class="form-control individualBookQnty" id="quantity_'+RowNum+'" onkeyup="multiply('+RowNum+');" autocomplete="off">'; 
    html +='</td>'; 
    html +='<td>';
    html +='<input type="number" step="any" name="purchase_details['+RowNum+'][unit_price]" class="form-control individualBookPrice" id="rate_'+RowNum+'" onkeyup="multiply('+RowNum+');" autocomplete="off">'; 
    html +='</td>';
    html +='<td>';
