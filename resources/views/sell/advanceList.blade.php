...
<section class="content-header">
  <h1> Advance List <small></small> </h1>
  <ol class="breadcrumb">
    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-list-alt"></i> Advance List</h3>
        ...
        <div class="box-body">
          <div class="row">
                  ...
                  <tbody>
                    <tr>
                      <td style="text-align: center;">
                        <form method="post" action="{{ route('advance-list.filter') }}">
            ...
            <div class="col-md-12" id="printTable">
              <center><h4 style="margin: 0px">Advance List</h4></center>
                ...
                <table style="width: 100%; font-size: 12px;" cellspacing="0" cellpadding="0"> 
                  <thead> 
                    <tr style="background: #ccc;"> 
                      ...
                      <th style="font-weight: bold; border: 1px solid #ddd; padding: 3px 3px">Advance</th>
                    </tr>
                  </thead>
                  <tbody> 
                    <?php                           
                    ...
                    <tr> 
                      ...
                      <td style="border: 1px solid #ddd; padding: 3px 3px">{{number_format($data->advance, 2)}}</td>
                    </tr>
                    <?php
                  ...
                  <tfoot> 
                    <tr> 
                      ...
                      <td style="font-weight: bold; border: 1px solid #ddd; padding: 3px 3px"><b>{{Session::get('currency')}} {{number_format($totalAdvance, 2)}}</b></td>
