    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-exchange"></i> Create Job Card</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <div class="row">
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-4">
                          <div class="form-group">
                              ...
                              <input type="text" name="receive_date_time" class="form-control datetimepicker" autocomplete="off">
                          </div>
                      </div>
                      <div class="col-md-4">
                          <div class="form-group">
                              <label>Delivery Date & Time</label>
                              <input type="text" name="delivery_date_time" class="form-control datetimepicker" autocomplete="off">
                          </div>
                      </div>
                  </div>
                  ...
                  <table class="table"> 
                    ...
                    <tbody class="service_container"> 
                      <tr id="div_{{$row_num}}">
                        ...
                        <td> 
                          <input type="text" name="service_details[{{$row_num}}][instruction]" class="form-control" id="instruction_{{$row_num}}" required="" autocomplete="off">
                        </td>
                        <td style="width: 20%"> 
...
<script type="text/javascript">
  ...
  function addparts(){ 
    ...
    html +='</td>'; 
    html +='<td>';
    html +='<input type="number" step="any" name="parts_details['+RowNum2+'][unit_price]" class="form-control" id="rate_'+RowNum2+'" onkeyup="multiply('+RowNum2+');" required="" autocomplete="off">'; 
    html +='</td>';
    html +='<td>';
