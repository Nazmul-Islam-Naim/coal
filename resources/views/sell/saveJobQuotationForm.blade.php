...
@section('title', 'Save Job Quotation')
@section('content')
...
<section class="content">
  ...
  <div class="row">
    {!! Form::open(array('route' =>['save-job-quotation'],'method'=>'POST')) !!}
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-exchange"></i> Save Job Quotation</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <div class="row">
                  ...
                  <div class="row">
                      <div class="col-md-4">
                          <div class="form-group">
                            <?php
                                $count = DB::table('save_quotation')->orderBy('id', 'DESC')->first();
                                $invNo = "";
                                if(!empty($count->id)){
                                    $invNo = $count->id + 1;
                                }else{
                      ...
                      <div class="col-md-4">
                          <div class="form-group">
                              ...
                              <input type="datetime-local" name="receive_date_time" class="form-control datetimepicker" autocomplete="off">
                          </div>
                      </div>
                      <!--<div class="col-md-4">
                          <div class="form-group">
                              <label>Delivery Date & Time</label>
                              <input type="datetime-local" name="delivery_date_time" class="form-control datetimepicker" autocomplete="off">
                          </div>
                      </div>-->
                      <div class="col-md-4">
                          <div class="form-group">
                      ...
                      <div class="col-md-4">
                          <div class="form-group">
                              <label>Brand</label>
                              <input type="text" name="car_band" class="form-control" autocomplete="off">
                          </div>
                      </div>
                      <div class="col-md-4">
                          <div class="form-group">
                              <label>Engine</label>
                              <input type="text" name="car_engine" class="form-control" autocomplete="off">
                          </div>
                      </div>
                      ...
                      <div class="col-md-4">
                          <div class="form-group">
                              <label>VIN</label>
                              <input type="text" name="car_vin" class="form-control" autocomplete="off">
                          </div>
                      </div>
                      <div class="col-md-4">
                          <div class="form-group">
                              <label>Odometer</label>
                              <input type="text" name="car_odometer" class="form-control" autocomplete="off">
                          </div>
                      </div>
                  </div>
                </div>
                  ...
                  <table class="table"> 
                    ...
                    <tbody class="service_container"> 
                      <tr id="div_{{$row_num}}">
                        ...
                        <td> 
                          <input type="text" name="service_details[{{$row_num}}][instruction]" class="form-control" id="instruction_{{$row_num}}">
                        </td>
                        <td style="width: 20%"> 
                          <input type="number" step="any" name="service_details[{{$row_num}}][cost]" class="form-control" id="cost_{{$row_num}}" onkeyup="getallcost(<?php echo $row_num?>);" required="" autocomplete="off">
                        </td>
                        <td style="width: 20%">
                          ...
                          <input type="hidden" name="servicetotal[]" class="form-control" id="ServiceTotal_{{$row_num}}" readonly="">
                        </td>
                    ...
                    <tfoot>
                      <tr> 
                        ...
                        <td>
                          <input type="text" name="sub_total" class="form-control" id="serviceSubTotal" value="0" readonly="">
                        </td>
                        <td>
                          <input type="number" step="any" name="vat_percent" class="form-control" id="vatPercent" onkeyup="vatCalculate(this.value);" placeholder="Vat%" autocomplete="off">
                          <input type="hidden" value="0" id="vatPercentHidden">
                          <input type="hidden" name="vat_amount" value="0" id="vatAmount">
                        </td>
                        <td>
                  ...
                  <table class="table"> 
                    ...
                    <tbody class="parts_container"> 
                      <tr id="div2_{{$row_num2}}"> 
                        ...
                        <td> 
                          <input type="text" class="form-control" id="stockqnty_{{$row_num2}}" readonly>
                        </td>
                        <td> 
                          <input type="number" step="any" name="parts_details[{{$row_num2}}][quantity]" class="form-control" id="quantity_{{$row_num2}}" onkeyup="multiply(<?php echo $row_num2?>);" required="" autocomplete="off">
                        </td>
                        <td> 
                          <input type="number" step="any" name="parts_details[{{$row_num2}}][unit_price]" class="form-control" id="rate_{{$row_num2}}" onkeyup="multiply(<?php echo $row_num2?>);" required="" autocomplete="off">
                          <input type="hidden" name="parts_details[{{$row_num2}}][purchase_value]" value="" id="purchaserate_<?php echo $row_num2?>">
                        </td>
                        <td> 
                          <input type="text" name="partstotal[]" class="form-control" id="PartTotal_{{$row_num2}}" readonly="">
                        </td>
                        <td></td>
                      </tr> 
                    </tbody>
                    <tfoot>
                      <tr> 
                        ...
                        <td>
                          <input type="text" name="sub_total" class="form-control" id="partSubTotal" value="0" readonly="">
                        </td>
                        <td>
                ...
                <div class="row">
                  <div class="col-md-9">
                    <div class="form-group" style="margin-top: -20px;">
                      ...
                      <input type="number" name="total_amount" class="form-control" id="TotalAmount" value="0" required="" readonly="">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      <input type="submit" name="purchase" class="btn btn-md btn-warning" value="Save Quotation" style="padding: 10px 50px;font-weight: bold">
                    </div>
                  </div>
                </div>
            </div>
