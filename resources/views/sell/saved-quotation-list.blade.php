...
@section('title', 'Saved Quotation List')
@section('content')
...
<section class="content-header">
  <h1> Saved Quotation List <small></small> </h1>
  <ol class="breadcrumb">
    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-list-alt"></i> Saved Quotation List</h3>
        ...
        <div class="box-body">
          <div class="row">
                  ...
                  <tbody>
                    <tr>
                      <td style="text-align: center;">
                        <form method="post" action="{{ route('saved-quotation-list.filter') }}">
            ...
            <div class="col-md-12" id="printTable">
              <center><h4 style="margin: 0px">Job Report</h4></center>
                ...
                <table style="width: 100%; font-size: 12px;" cellspacing="0" cellpadding="0"> 
                  <thead> 
                    <tr style="background: #ccc;"> 
                      ...
                      <th style="font-weight: bold; border: 1px solid #ddd; padding: 3px 3px">Quotation No</th>
                      ...
                      <th style="font-weight: bold; border: 1px solid #ddd; padding: 3px 3px">Quotation</th>
                  ...
                  <tbody> 
                    ...
                    <tr> 
                      ...
                      <td style="border: 1px solid #ddd; padding: 3px 3px"><a href="{{$baseUrl.'/'.config('app.sell').'/saved-job-quotation-detail/'.$data->tok}}">{{$data->job_card_no}}</a></td>
                      ...
                      <td style="border: 1px solid #ddd; padding: 3px 3px"><a href="{{$baseUrl.'/'.config('app.sell').'/saved-job-quotation-detail/'.$data->tok}}">Quotation</a></td>
                      ...
                      <td style="border: 1px solid #ddd; padding: 3px 3px">
                        <a href="{{$baseUrl.'/'.config('app.sell').'/sell-saved-quotation-form/'.$data->customer_id.'/'.$data->tok}}" class="btn btn-success btn-sm"><i class="fa fa-plus-circle"></i> Sell</a> 
                      </td>
                    </tr>
                    <?php
                  ...
                  <tfoot> 
                    <tr> 
                      ...
                      <td style="font-weight: bold; border: 1px solid #ddd; padding: 3px 3px"><b>{{number_format($totalSell, 2)}}</b></td>
