...
@section('title', 'Tok Wise Invoice')
@section('content')
...
<section class="content-header">
  <h1> Tok Wise Invoice <small></small> </h1>
  <ol class="breadcrumb">
    <li><a href="{{URL::To('dashboard')}}"><i class="fa fa-dashboard"></i> Home</a></li>
    <li class="active">Tok Wise Invoice</li>
  </ol>
</section>
<style type="text/css">
    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-list-alt"></i> Tok Wise Invoice</h3>
        ...
        <div class="box-body">
          <div class="row" id="printTable">
            ...
            <div class="col-md-12" >
                <center><h4 style="margin: 0px"><u>BILL</u></h4></center><br>
	                   ...
	                   <thead> 
	                       <tr> 
                			...
                			<tr> 
                				...
                				<td style="border: 1px solid #ddd; padding: 3px 3px">{{number_format($singleData->vat_amount,2)}} ({{round($singleData->vat_percent,2)}}%)</td>
                			</tr>
