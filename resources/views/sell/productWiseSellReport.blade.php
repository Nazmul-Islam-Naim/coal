...
@section('title', 'Product Wise Sell Report')
@section('content')
...
<section class="content-header">
  <h1> {{ __('messages.product_wise_sell_report') }} <small></small> </h1>
  <ol class="breadcrumb">
    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-list-alt"></i> {{ __('messages.product_wise_sell_report') }}</h3>
          <div class="form-inline pull-right">
            <!--<div class="input-group"> 
              <a href="{{$baseUrl.'/'.config('app.sell').'/pos-sell'}}" class="btn btn-success btn-xs"><i class="fa fa-exchange"></i> POS Sale</a>
            </div>
            <div class="input-group"> 
              <a href="{{$baseUrl.'/'.config('app.sell').'/product-sell'}}" class="btn btn-success btn-xs"><i class="fa fa-exchange"></i> Direct Sale</a>
            </div>
            <div class="input-group"> 
        ...
        <div class="box-body">
          <div class="row">
                  ...
                  <tbody>
                    <tr>
                      <td style="text-align: center;">
                        <form method="post" action="{{ route('product-wise-sell-report.filter') }}">
            ...
            <div class="col-md-12" id="printTable">
              <center><h4 style="margin: 0px">{{ __('messages.product_wise_sell_report') }}</h4></center>
                ...
                <table style="width: 100%; font-size: 12px;" cellspacing="0" cellpadding="0"> 
                  <thead> 
                    <tr style="background: #ccc;"> 
                      ...
                      <th style="font-weight: bold; border: 1px solid #ddd; padding: 3px 3px">{{ __('messages.unit_price') }}</th>
                  ...
                  <tbody> 
                    ...
                    <tr> 
                      ...
                      <td style="border: 1px solid #ddd; padding: 3px 3px">{{number_format($total = $data->quantity*$data->unit_price, 2)}}</td>
                    </tr>
                    <?php
                      $totalPrice += $total;
                      $qnty += $data->quantity;
                  ...
                  <tfoot> 
                    <tr> 
                      ...
                      <td style="font-weight: bold; border: 1px solid #ddd; padding: 3px 3px"><b>{{number_format($qnty, 2)}}</b></td>
