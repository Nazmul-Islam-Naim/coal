...
<section class="content-header">
  <h1> Customer List To Create Job Card <small></small> </h1>
  <ol class="breadcrumb">
    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-list-alt"></i> Customer List To Create Job Cart</h3>
                ...
                <table class="table table-bordered table-striped table-responsive table-hover myTable" width="100%"> 
                  ...
                  <tbody> 
                    ...
                    <tr> 
                      ...
                      <td>{{$data->address}}</td>
                      <td>
                        <a href="{{$baseUrl.'/'.config('app.sell').'/create-job-card/'.$data->id}}" class="btn btn-success btn-sm pull-right"><i class="fa fa-plus-circle"></i> Create</a>
                      </td>
                    </tr>
                    @endforeach
                    @if($rowCount==0)
