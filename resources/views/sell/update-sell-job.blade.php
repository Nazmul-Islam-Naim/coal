                      ...
                      <div class="col-md-4">
                          <div class="form-group">
                            ...
                            ?>
                              ...
                              <input type="text" name="job_card_no" value="{{$singleData->job_card_no}}" class="form-control" readonly="" autocomplete="off">
                ...
                <div class="row">
                  ...
                  <div class="col-md-2">
                    <div class="form-group" style="margin-top: -20px;">
                      ...
                      <input type="hidden" id="Discount" value="{{$singleData->discount}}">
                    </div>
                  </div>
                  <div class="col-md-3">
                      <div class="form-group" style="margin-top: -20px;"> 
