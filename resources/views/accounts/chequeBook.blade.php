...
<section class="content-header">
  <h1> {{ __('messages.cheque_book') }} <small></small> </h1>
  <ol class="breadcrumb">
    <li><a href="{{URL::To('dashboard')}}"><i class="fa fa-dashboard"></i> {{ __('messages.home') }}</a></li>
    <li class="active">{{ __('messages.cheque_book') }}</li>
  </ol>
</section>
<!-- Main content -->
<section class="content">
  ...
  <div class="row">
    <div class="col-md-4">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-plus-circle"></i> {{ __('messages.add') }} {{ __('messages.cheque_book') }}</h3>
        </div>
        <!-- /.box-header -->
    ...
    <div class="col-md-8">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-list-alt"></i> {{ __('messages.cheque_book') }} {{ __('messages.list') }}</h3>
          <div class="form-inline pull-right">
            <div class="input-group">
              <a href="{{$baseUrl.'/'.config('app.account').'/cheque-no'}}" class="btn btn-success btn-xs"><i class="fa fa-list-alt"></i> {{ __('messages.cheque_no') }}</a>
            </div>
            <div class="input-group">
                    ...
                    <tr> 
                      ...
                      <td> 
                        <div class="form-inline">
                          ...
                          <div class = "input-group"> 
                            {{Form::open(array('route'=>['cheque-book.destroy',$data->id],'method'=>'DELETE'))}}
                            ...
                            <div class="modal-dialog modal-md">
                              ...
                              <div class="modal-content">
                                <div class="modal-header">
                                  ...
                                  <h4 class="modal-title">{{ __('messages.edit') }} {{ __('messages.cheque_book') }}</h4>
                                </div>

                                {!! Form::open(array('route' =>['cheque-book.update', $data->id],'method'=>'PUT')) !!}
                                    ...
                                    <div class="col-md-12">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <select name="bank" class="form-control" required> 
                                          <option value="">Select</option>
                                          @foreach($allbank as $bank)
                                          <option value="{{$bank->id}}" {{($bank->id==$data->bank)? 'selected':''}}>{{$bank->bank_name}}</option>
                                          @endforeach
                                        </select>
                                      </div>
                                    </div>
