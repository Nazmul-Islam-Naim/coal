...
<section class="content-header">
  <h1> {{ __('messages.cheque_no') }} <small></small> </h1>
  <ol class="breadcrumb">
    <li><a href="{{URL::To('dashboard')}}"><i class="fa fa-dashboard"></i> {{ __('messages.home') }}</a></li>
    <li class="active">{{ __('messages.cheque_no') }}</li>
  </ol>
</section>
<!-- Main content -->
<section class="content">
  ...
  <div class="row">
    <div class="col-md-4">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-plus-circle"></i> {{ __('messages.add') }} {{ __('messages.cheque_no') }}</h3>
        </div>
        <!-- /.box-header -->
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="form-group"> 
                ...
                <input type="text" name="cheque_no" class="form-control" value=""  autocomplete="off" required>
              </div>
              <div class="form-group">
    ...
    <div class="col-md-8">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-list-alt"></i> {{ __('messages.cheque_no') }} {{ __('messages.list') }}</h3>
          <div class="form-inline pull-right">
            <div class="input-group">
              <a href="{{$baseUrl.'/'.config('app.account').'/bank-account'}}" class="btn btn-success btn-xs"><i class="fa fa-list-alt"></i> {{ __('messages.accounts') }}</a>
            </div>
          </div>
        </div>
        <!-- /.box-header -->
                            ...
                            <div class="modal-dialog modal-md">
                              ...
                              <div class="modal-content">
                                <div class="modal-header">
                                  ...
                                  <h4 class="modal-title">{{ __('messages.edit') }} {{ __('messages.cheque_no') }}</h4>
                                </div>
                                ...
                                <div class="modal-body">
                                  <div class="row">
                                    <div class="col-md-12">
                                      <div class="form-group">
                                        <label>{{ __('messages.cheque_book') }}</label>
                                        <strong style="color: red">*</strong> :
                                        <select name="cheque_book" class="form-control" required> 
                                          <option value="">Select</option>
                                          @foreach($allchequebook as $chequebook)
                                      ...
                                      <div class="form-group">
                                        <label for="Group Name">{{ __('messages.cheque_no') }}</label>
                                        <strong style="color: red">*</strong> :
                                        <input type="text" class="form-control" value="{{$data->cheque_no}}" name="cheque_no" autocomplete="off" required>
                                      </div>
                                    </div>
                                  </div>
                                </div>
