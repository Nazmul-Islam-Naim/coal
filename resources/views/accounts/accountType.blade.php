...
<section class="content-header">
  <h1> {{ __('messages.account_type') }} <small></small> </h1>
  <ol class="breadcrumb">
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-4">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-plus-circle"></i> {{ __('messages.account_type') }} {{ __('messages.add') }}</h3>
        </div>
        <!-- /.box-header -->
    ...
    <div class="col-md-8">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-list-alt"></i> {{ __('messages.account_type') }} {{ __('messages.list') }}</h3>
          <a href="{{$baseUrl.'/'.config('app.account').'/bank-account'}}" class="btn btn-success btn-xs pull-right"><i class="fa fa-list-alt"></i> {{ __('messages.bank_account') }}</a>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <div class="row">
                    ...
                    <tr> 
                      ...
                      <td> 
                        <div class="form-inline">
                          ...
                          <!--<div class = "input-group"> 
                            {{Form::open(array('route'=>['account-type.destroy',$data->id],'method'=>'DELETE'))}}
                            ...
                            <div class="modal-dialog modal-md">
                              ...
                              <div class="modal-content">
                                <div class="modal-header">
                                  ...
                                  <h4 class="modal-title">{{ __('messages.edit') }} {{ __('messages.account_type') }}</h4>
                                </div>

                                {!! Form::open(array('route' =>['account-type.update', $data->id],'method'=>'PUT')) !!}
