...
@section('title', 'Lighter Agency Ledger')
@section('content')
<!-- Content Header (Page header) -->
<section class="content-header">
  <h1> {{ __('messages.lighter_agency_ledger') }} <small></small> </h1>
  <ol class="breadcrumb">
    <li><a href="{{URL::To('dashboard')}}"><i class="fa fa-dashboard"></i> {{ __('messages.home') }}</a></li>
    <li class="active">{{ __('messages.lighter_agency_ledger') }}</li>
  </ol>
</section>
<!-- Main content -->
    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-list-alt"></i> {{ __('messages.lighter_agency_ledger') }}</h3>
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-12" id="printTable">
              ...
              <center><h4 style="margin:0">{{ __('messages.lighter_agency_ledger') }}</h4></center>
              <div class="table-responsive">
                <table style="width: 100%; font-size: 12px;" cellspacing="0" cellpadding="0"> 
                  <thead>
                    <tr> 
                      <td style="border: 1px solid #ddd; padding: 3px 3px">{{ __('messages.name') }}</td>
                      <td style="border: 1px solid #ddd; padding: 3px 3px">{{$singledata->agency_name}}</td>
                    ...
                    <tr> 
                      ...
                      <td style="border: 1px solid #ddd; padding: 3px 3px">{{ __('messages.owner_name') }}</td>
                      <td style="border: 1px solid #ddd; padding: 3px 3px">{{$singledata->owner_name}}</td>
                    </tr>
                  </thead>
                </table>
                <br>
