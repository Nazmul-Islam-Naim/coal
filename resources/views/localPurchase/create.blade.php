  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-primary">
        {!! Form::open(array('route' =>['local-purchases.store'],'method'=>'POST')) !!}
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-plus-circle"></i> Create Local Purchase</h3>
        ...
        <div class="box-footer">
          <div class="form-group">
            <input type="submit" class="btn btn-success btn-sm" value="Create Local Purchase" onclick="return confirm('Are you sure?')" style="width: 15%; float: right; font-weight: bold">
            {!! Form::close() !!}
          </div>
        </div>
      </div>
