...
<section class="content-header">
  <h1> Exporter Management <small></small> </h1>
  <ol class="breadcrumb">
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-4">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-plus-circle"></i> Add Exporter</h3>
        </div>
        <!-- /.box-header -->
        {!! Form::open(array('route' =>['exporter-info.store'],'method'=>'POST')) !!}
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
    ...
    <div class="col-md-8">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-list-alt"></i> Exporter List</h3>
                    ...
                    <tr> 
                      ...
                      <td> 
                        <div class="form-inline">
                          ...
                          <div class = "input-group"> 
                            {{Form::open(array('route'=>['exporter-info.destroy',$data->id],'method'=>'DELETE'))}}
                            ...
                            <div class="modal-dialog modal-sm">
                              ...
                              <div class="modal-content">
                                <div class="modal-header">
                                  ...
                                  <h4 class="modal-title"><i class="fa fa-edit"></i> Edit Exporter Information</h4>
                                </div>

                                {!! Form::open(array('route' =>['exporter-info.update', $data->id],'method'=>'PUT')) !!}
