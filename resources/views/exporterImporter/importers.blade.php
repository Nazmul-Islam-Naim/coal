...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">{{ __('messages.importer_mm') }}</li>
  </ol>
</section>
<!-- Main content -->
<section class="content">
  ...
  <div class="row">
    <div class="col-md-4">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-plus-circle"></i> Add Importer</h3>
        </div>
        <!-- /.box-header -->
        {!! Form::open(array('route' =>['importer-info.store'],'method'=>'POST')) !!}
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
    ...
    <div class="col-md-8">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> <i class="fa fa-list-alt"></i> Importer List</h3>
                    ...
                    <tr> 
                      ...
                      <td> 
                        <div class="form-inline">
                          ...
                          <div class = "input-group"> 
                            {{Form::open(array('route'=>['importer-info.destroy',$data->id],'method'=>'DELETE'))}}
                            ...
                            <div class="modal-dialog modal-sm">
                              ...
                              <div class="modal-content">
                                <div class="modal-header">
                                  ...
                                  <h4 class="modal-title"><i class="fa fa-edit"></i> Edit Importer Information</h4>
                                </div>

                                {!! Form::open(array('route' =>['importer-info.update', $data->id],'method'=>'PUT')) !!}
                                  ...
                                  <div class="row">
                                    <div class="col-md-12">
                                      <div class="col-md-12">
                                        ...
                                        <div class="form-group"> 
                                          <label>{{ __('messages.phone') }} <span style="color:red">*</span></label>
                                          <input type="text" name="phone" class="form-control" value="{{$data->phone}}" autocomplete="off" required>
                                        </div>
                                        <div class="form-group"> 
                                          <label>{{ __('messages.address') }} <span style="color:red">*</span></label>
